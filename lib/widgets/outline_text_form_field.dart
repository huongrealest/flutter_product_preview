...
import '../common/theme/app_border_and_radius.dart';
import '../common/theme/app_form_field.dart';
...
///
/// Remember to call [TextEditingController.offSocket] of the [TextEditingController]
  ...
  OutlineTextFormField({
    ...
    String? label,
        ...
        super(
          ...
          autovalidateMode: autovalidateMode ??
              (validator != null ? AutovalidateMode.disabled : null),
          builder: (FormFieldState<String> field) {
            final _TextFormFieldState state = field as _TextFormFieldState;
            final InputDecoration effectiveDecoration = (decoration ??
                    (AppFormField.outlineInputDecoration))
                .copyWith(
                  labelText: label,
                )
                ...
                TextField(
                  ...
                  decoration: effectiveDecoration.copyWith(
                    enabledBorder: state.hasError
                        ? AppBorderAndRadius.outlineInputErrorBorder
                        : null,
